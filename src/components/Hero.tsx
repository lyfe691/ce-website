...
export const Hero = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-gray-900 via-purple-900/20 to-gray-900">
      {/* Background Grid */}
      ...
      <div className="container relative mx-auto px-4">
        <div className="text-center">
          ...
          >
            ...
            >
              <Chrome className="h-8 w-8 text-purple-500" aria-label="Chrome Icon" />
            </motion.div>
            ...
            <h1 className="text-5xl font-bold tracking-tight text-white sm:text-7xl">
              ...
              <span className="relative whitespace-nowrap">
                ...
                <span className="relative ml-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-purple-100">
                  Extractor
                </span>
              </span>
            </h1>
            ...
            >
              <Button
                ...
                onClick={() => window.open("https://chromewebstore.google.com/detail/website-code-extractor/foppgeakfpkdghmmmflmblcidoofpohm", "_blank")}
              >
                <span className="relative z-10 flex items-center">
                  <Chrome className="mr-2 h-5 w-5 transition-transform group-hover:rotate-12" aria-label="Chrome Icon" />
                  Get Extension
                </span>
      ...
      <div className="absolute inset-x-0 -z-10 transform-gpu overflow-hidden blur-3xl" aria-hidden="true">
        <div
          className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-purple-500 to-purple-900 opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          style={{
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        ...
        >
          <ArrowDown className="h-6 w-6 text-white mb-1" />
          <span className="text-sm text-gray-300">Scroll to view more</span>
        </motion.div>
      </div>
    </div>
  );
