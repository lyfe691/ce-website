...
export const Hero = () => {
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-gray-900 via-purple-900/20 to-gray-900 py-24 sm:py-32">
      ...
      <div className="container relative mx-auto px-4">
        <div className="text-center animate-fade-up [--animation-delay:200ms]">
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-purple-600/10 mb-8">
            ...
            <h1 className="text-5xl font-bold tracking-tight text-white sm:text-7xl">
              ...
              <span className="relative whitespace-nowrap">
                ...
                <span className="relative ml-4 text-purple-400">Extractor</span>
              </span>
            </h1>
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Button
                size="lg"
                className="group bg-purple-600 hover:bg-purple-700 text-white px-8 py-6 text-lg shadow-[0_0_0_3px_rgba(139,92,246,0.3)] hover:shadow-[0_0_0_3px_rgba(139,92,246,0.5)] transition-all duration-300"
